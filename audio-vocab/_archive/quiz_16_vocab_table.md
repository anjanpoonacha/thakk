# Quiz 16 — Kodava Padipu Vocab Table

**Topic:** Animals in Kodava Takk — Kannada/English animal names translated to Kodava

## Animals — idhunge Kodava takkalu inthondh ennuva

| English | Kodava Takk | Explanation |
|---------|-------------|-------------|
| Rabbit | moNNa | common small mammal |
| Stag / Male deer | kadime | deer; kadime also used for deer generally |
| Squirrel | koriya | small tree-dwelling rodent |
